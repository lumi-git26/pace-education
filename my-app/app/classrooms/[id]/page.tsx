...
import { ArrowLeft, Users, User, BookOpen, CheckCircle2, Clock, XCircle, Calendar } from "lucide-react";
...
export default function ClassroomDetailPage() {
  ...
  async function handleRequestJoin() {
    ...
    const { error: insertErr } = await supabase.from("classroom_members").insert({
      learner_id: user.id,
                ...
                <div className="flex items-center gap-3 text-muted">
                  ...
                  <p className="text-[15px] font-medium">
                    ...
                    <span className="font-bold text-ink">
                      {classroom.profiles?.full_name ?? "Instructor"}
                    </span>
                  </p>
                </div>
            ...
            <div className="w-full md:w-[260px] shrink-0 bg-white/80 rounded-[24px] p-6 shadow-sm border border-white">
              {membershipStatus === "active" ? (
                ...
                <div className="flex flex-col items-center text-center">
                  ...
                  <h3 className="font-bold text-ink mb-1">Request sent</h3>
                  <p className="text-[12px] text-muted">
                    Waiting for the instructor to approve your request.
                  </p>
                </div>
                ...
                <div className="flex flex-col items-center text-center">
                  ...
                  <h3 className="font-bold text-ink mb-1">Request declined</h3>
                  <p className="text-[12px] text-muted">
                    Your request to join wasn&apos;t approved this time.
                  </p>
                </div>
              ) : (
                <div className="flex flex-col">
                  ...
                  <p className="text-[12px] text-muted mb-5 leading-relaxed">
                    Request to join — the instructor will need to approve you
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
            <div className="p-5 rounded-2xl bg-[#F9F9F8] border border-dashed border-line/80">
              ...
              <p className="text-[12px] text-muted leading-relaxed">
                Access specific learning tracks and materials selected by your
                instructor.
              </p>
            </div>
            <div className="p-5 rounded-2xl bg-[#F9F9F8] border border-dashed border-line/80">
              ...
              <p className="text-[12px] text-muted leading-relaxed">
                Join regular meetings and interact directly with peers and
                lecturers.
              </p>
            </div>
            <div className="p-5 rounded-2xl bg-[#F9F9F8] border border-dashed border-line/80">
              ...
              <p className="text-[12px] text-muted leading-relaxed">
                Learn together with a dedicated group of students in the same
                schedule.
              </p>
            </div>
          </div>
